...
app.get('/tech', async(req, res) =>{
    ...
    const news = await axios.get(`https://newsapi.org/v2/everything?q=bitcoin&pageSize=9&language=en&apiKey=49d58dd4dc4d4b11b4a20e32911bd048`);
...
app.get('/dom', async(req, res) =>{
    ...
    const news = await axios.get(`https://newsapi.org/v2/everything?q=economy&pageSize=9&language=en&apiKey=49d58dd4dc4d4b11b4a20e32911bd048`);
        console.log(news.data);
